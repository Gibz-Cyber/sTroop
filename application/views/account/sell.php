      ...
      <section id="start-all-items" class="all-items">
        <div class="container">
            <div class="all-items-title w-100 pt-5 mt-5 text-center">
              <h3 class="display-4--title mt-1 fw-bold">What do you want to sell?</h3>
            </div>
        </div>
    </section>
    ...
    <section id="items-categories" class="categories all-items-categories">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=vehicles'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=electronics'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=properties'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=leisure'); ?>">
          ...
          <div class="row align-items-center">
            <div class="col-md-3">
              <div class="card shadow text-center " >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=services'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=kids items'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=fashion'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=sports'); ?>">
          ...
          <div class="row align-items-center">
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=education'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=industrial'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=home and garden'); ?>">
            ...
            <div class="col-md-3">
              <div class="card shadow text-center" >
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=food and agriculture'); ?>">
          ...
          <div class="row align-items-center">
            <div class="col-md-3">
              <div class="card shadow text-center">
                <a href="<?php echo base_url('/index.php/user/sellAdPosting?adCategory=other'); ?>">
