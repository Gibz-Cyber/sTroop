              ...
              <div class="mob mt-5 d-flex">
                <div class="container">
                    <div class="list-group text-center shadow">
                        ...
                        <a href="rental/ad_rental.php" class="list-group-item">Properties for Rent</a>
                        <a href="vacancies/vacancies.php" class="list-group-item">Job vacancies</a>
                    </div>
                </div>
                <div class="container" >
                    <div class="list-group text-center shadow">
                        <h4  class="list-group-item-heading text-white p-4">Look for Something</h4>
                        <a href="Look_rent/look_rent.php" class="list-group-item">Look Properties for Rent</a>
