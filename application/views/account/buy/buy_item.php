              ...
              <!--left corner category selector end from here-->
                <div class="col-12 col-lg-9 shadow mt-3 p-1">
                    <div class="form w-100 pb-2">
                            ...
                            <div class="alert alert-danger" id="warning"><p align="center">Oops! something went wrong. Please try again later.</p></div>
                            <a href="#" class="btn btn-outline-secondary" id="prev1">Previous</a>
          ...
          $("#btnsubmit").click(function(event){
            ...
            $.ajax({
              ...
              beforeSend:function(){
                ...
                btn.disabled = true; $("#post-spinner").show();
                $("#cases-error").html(null);$("dist-error").html(null);$("#title-error").html(null);$("#desc-error").html(null);$("#price-error").html(null);$("#warning").hide();

              },success:function(respData){

                $("#post-spinner").hide(); btn.disabled = false;
                
                if(!respData.success){
                  //form validation error start from here
                  if(respData.district != ""){

                    $("#step-2").hide();$(".step-1").show();$("#pro").css("width","50%");$("#pro1").html("Step 1");
                  ...
                  if(!respData.ad){
                    ...
                    $("#post-spinner").show();btn.disabled = true;window.location.href="<?php echo base_url('/index.php/user/pendingAds'); ?>";
